...
const char * kLogPath = "\\My Games\\Skyrim\\SKSE64\\skse.log";

STATIC_ASSERT(RUNTIME_VERSION == RUNTIME_VERSION_1_1_47_0);
...
const char * kLogPath = "\\My Games\\Skyrim\\SKSE64\\skse_editor.log";
